          ...
          <div className="flex items-center mb-8 ">
            ...
            <div className="flex-1">
              <div className="relative mb-2">
                ...
                <label
                  htmlFor="avatar"
                  className="absolute bg-secondary-100 p-2 rounded-full hover:cursor-pointer -top-4 left-24">
                  <RiEdit2Line />
                </label>
            ...
            <div className="flex-1 flex items-center gap-4">
              <div className="w-full">
                <select
                  ...
                  <option value="venzuela" selected>
                    Venzuela
                  </option>
                </select>
              </div>
          ...
          <div className="flex gap-x-2">
            ...
            <div>
              ...
              <p className="text-gray-500">
                ...
                your account. To log in, in additional you'll need to provide a
                6 digit code
              </p>
            </div>
          </div>
          <div>
            <button className="bg-green-600/70 hover:bg-green-600 py-2 px-4 rounded-lg text-gray-100 transition-colors">
              Enabel
            </button>
          </div>
        </div>
      ...
      <div className="bg-secondary-100 p-8 rounded-xl">
          ...
          <div className="flex gap-x-2">
            ...
            <div className="flex-1">
              <h5 className="text-gray-100 text-xl">
                You are desctivating your account
              </h5>
              <p className="text-gray-500">
        ...
        <form className="flex gap-4">
          ...
          <label htmlFor="idInactive" className="text-gray-500">
            I confirme my account desactivation
          </label>
        </form>
        <hr className="my-8 border-gray-500/30" />
        <div className="flex justify-end">
