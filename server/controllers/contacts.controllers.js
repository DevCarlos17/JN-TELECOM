...
export const updateContact = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ message: "¡Actualizado con éxito!", status: true, updatedContact });
  } catch (error) {
...
export const deleteContact = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ message: "Eliminado corractamente", contact: deletedContact, status: true, })
  } catch (error) {
